pipeline {
    ...
    stages {
        ...
        stage("Nexus") {
            steps {
                echo "NEXUS"
                nexusPublisher nexusInstanceId: 'devops-usach-nexus', nexusRepositoryId: 'devops-usach-nexus', packages: [[$class: 'MavenPackage', mavenAssetList: [[classifier: '', extension: '', filePath: '/var/jenkins_home/workspace/ejemplo-gradle/build/DevOpsUsach2020-0.0.2.jar']], mavenCoordinate: [artifactId: 'DevOpsUsach2020', groupId: 'com.devopsusach2020', packaging: 'jar', version: '0.0.2']]]
            }
        }
    }
}